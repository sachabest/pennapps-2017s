...
#include "AnimNode_IKinemaConvertLocalToSolverSpace.generated.h"

USTRUCT()
struct IKINEMACORE_API FAnimNode_IKinemaConvertLocalToSolverSpace : public FAnimNode_Base
{
...
public:	
	...
	FAnimNode_IKinemaConvertLocalToSolverSpace();
	~FAnimNode_IKinemaConvertLocalToSolverSpace();
